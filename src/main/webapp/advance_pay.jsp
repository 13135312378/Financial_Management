        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-nav-link">
                ...
                <ul class="sidebar-nav sidebar-nav-sub" style="display: block;">
                    <%--预付款充值核销--%>
                    <li class="sidebar-nav-link">
                        <a href="advance_pay.jsp" class="sub-active">
                        ...
                        <div class="widget-body  am-fr">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
                                    审核日期&nbsp;:&nbsp;<input type="text" style="width:139px; " value="<%=date%>" id="datetimepicker_advance" data-date-format="yyyy-mm-dd">
                                </div>

                                <div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
                                    至&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="text" style="width:139px; " value="<%=date%>" id="datetimepicker1_advance" data-date-format="yyyy-mm-dd">
                                </div>
                                ...
                                <div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
                                    出账日期&nbsp;:&nbsp;<input type="text" style="width:139px; " value="<%=date%>" id="datetimepicker2_advance" data-date-format="yyyy-mm-dd">
                                </div>

                                <div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
                                    至&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="text" style="width:139px; " value="<%=date%>" id="datetimepicker3_advance" data-date-format="yyyy-mm-dd">
                                </div>
...
<script>
    ...
    $(function(){
        ...
        $('#datetimepicker_advance').datetimepicker();  //日期显示
        $('#datetimepicker1_advance').datetimepicker();  //日期显示
        $('#datetimepicker2_advance').datetimepicker();  //日期显示
        $('#datetimepicker3_advance').datetimepicker();  //日期显示

        //全选,设置chheckbox name='all' tbody id=tb
        $("input[name=advance_all]").click(function () {
            if (this.checked) {
                $("#advance_tb :checkbox").prop("checked", true);
            } else {
                $("#advance_tb :checkbox").prop("checked", false);
            }
        });
