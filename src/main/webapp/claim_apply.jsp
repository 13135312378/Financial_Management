                        ...
                        <div class="widget-body  am-fr">
                            ...
                            <div class="am-scrollable-horizontal">
                                <table width="100%" class="am-table am-table-bordered am-table-striped am-text-nowrap" id="example-r1" >
                                    ...
                                    <tr>
                                        <th>序号</th>
                                        <th><input type="checkbox" name="claim_all" value="1"></th>
                                        <th>理赔编号</th>
                                        <th>登记网点</th>
                                        <th>业务类型</th>
                                        <th>运单号</th>
    ...
    $(function(){
        var vm = new Vue({
            ...
            methods: {
                ...
                //核销
                claim_hexiao:function () {
                    $('#claimhexiao').modal({
                    });
                },
                //撤销核销
                claim_chexiao:function () {
                    $('#claimchexiao').modal({
                    });
                }
            },
        ...
        $('#datetimepicker_claim').datetimepicker();  //日期显示
        $('#datetimepicker1_claim').datetimepicker();  //日期显示
        $('#datetimepicker2_claim').datetimepicker();  //日期显示
        $('#datetimepicker3_claim').datetimepicker();  //日期显示

        //全选,设置chheckbox name='all' tbody id=tb
        $("input[name=claim_all]").click(function () {
            if (this.checked) {
                $("#claim_tb :checkbox").prop("checked", true);
            } else {
                $("#claim_tb :checkbox").prop("checked", false);
            }
        });
...
<%--模态框--%>
<%--批量查询--%>
<div class="am-modal am-modal-no-btn" tabindex="" id="claimsearch">
            ...
            <form action="" method="post">
                <table class="am-table am-table-centered am-text-middle am-text-nowrap" border="0">
                    <tr>
                        ...
                        <td>费用类型&nbsp;:&nbsp;<input type="text" style="width:146px;"/></td>
                        <td>
...
<div class="am-modal am-modal-confirm" tabindex="-1" id="claimhexiao">
    <div class="am-modal-dialog">
        <div class="am-btn am-btn-warning am-btn-primary am-btn-block">理赔信息的确认</div>
        <div class="am-modal-bd">
            你，确定要核销这条记录吗？
        </div>
...
<div class="am-modal am-modal-confirm" tabindex="-1" id="claimchexiao">
    <div class="am-modal-dialog">
        <div class="am-btn am-btn-warning am-btn-primary am-btn-block">理赔信息的撤销确认</div>
        <div class="am-modal-bd">
            你，确定要撤销核销这条记录吗？
        </div>
        <div class="am-modal-footer">
