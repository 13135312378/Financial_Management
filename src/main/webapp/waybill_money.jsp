...
<div class="am-g tpl-g">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-nav-link">
                ...
                <ul class="sidebar-nav sidebar-nav-sub" style="display: block;">
                    ...
                    <%--运单费用项核销--%>
                    <li class="sidebar-nav-link">
                        <a href="waybill_money.jsp" class="sub-active">
    ...
    <div class="tpl-content-wrapper" >
        ...
        <div class="container-fluid am-cf" style="height:26px;  ">
            <div class="page-header-heading" ><span class=""></span> 主营业务核销 <small>运单费用项核销 </small></div>
        </div>
                      ...
                      <div class="widget-body  am-fr">
                                ...
                                <div class="am-form-group">
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <button type="button" class="am-btn am-btn-default am-btn-success" @click="many_search()"><span class="am-icon-search"></span> 批量查寻</button>
                                            <button type="button" class="am-btn am-btn-default am-btn-secondary"  @click="many_hexiao()"><span class="am-icon-save"></span> 核销</button>
                                            <button type="button" class="am-btn am-btn-default am-btn-warning" @click="many_chexiao()"><span class="am-icon-reply"></span> 撤销核销</button>
                         ...
                         <form action="" method="post">
                            ...
                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
                                寄件日期&nbsp;:&nbsp;<input type="text" style="width:139px; " value="<%=date%>" id="datetimepicker" data-date-format="yyyy-mm-dd">
                            </div>

                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
                                至&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="text" style="width:139px; " value="<%=date%>" id="datetimepicker1" data-date-format="yyyy-mm-dd">
                            </div>
                            ...
                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
                                出账日期&nbsp;:&nbsp;<input type="text" style="width:139px; " value="<%=date%>" id="datetimepicker2" data-date-format="yyyy-mm-dd">
                            </div>

                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
                                至&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="text" style="width:139px; " value="<%=date%>" id="datetimepicker3" data-date-format="yyyy-mm-dd">
                            </div>
                            ...
                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
                                转账日期&nbsp;:&nbsp;<input type="text" style="width:139px; " value="<%=date%>" id="datetimepicker4" data-date-format="yyyy-mm-dd">
                            </div>

                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
                                至&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="text" style="width:139px; " value="<%=date%>" id="datetimepicker5" data-date-format="yyyy-mm-dd">
                            </div>
                            ...
                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                                核销项目&nbsp;&nbsp;:&nbsp;&nbsp;
                                <input  type="radio" name="radio" value="x" checked/>现付&nbsp;&nbsp;&nbsp;&nbsp;
                                <input  type="radio" name="radio" value="f" />回单付&nbsp;&nbsp;&nbsp;&nbsp;
                                <input  type="radio" name="radio" value="叉车费" />叉车费&nbsp;&nbsp;&nbsp;&nbsp;
                                <input  type="radio" name="radio" value="上门接货费" />上门接货费&nbsp;&nbsp;&nbsp;&nbsp;
                                <input  type="radio" name="radio" value="中转费" />中转费&nbsp;&nbsp;&nbsp;&nbsp;
                                <input  type="radio" name="radio" value="垫付回扣" />垫付回扣&nbsp;&nbsp;&nbsp;&nbsp;
                                <input  type="radio" name="radio" value="提付" />提付&nbsp;&nbsp;&nbsp;&nbsp;
                                <input  type="radio" name="radio" value="派件费" />派件费&nbsp;&nbsp;&nbsp;&nbsp;
                                <input  type="radio" name="radio" value="代收货款" />代收货款
                            </div>
                                    ...
                                    <table width="100%" class="am-table am-table-bordered am-table-striped am-text-nowrap" id="example-r1" >
                                        ...
                                        <tr class="gradeX" v-for="(verify,index) in verifys">
                                            ...
                                            <div class="tpl-table-black-operation">
                                                <a href="javascript:;" @click="waybill_yes(index)" v-if="verify.audit_status==0" >
                                                    <i class="am-icon-send-o"></i>
                                                    核销
                                                </a>

                                                <a href="javascript:;" @click="waybill_no(index)" v-if="verify.audit_status==1" class="tpl-table-black-operation-del">
                                                    <i class="am-icon-send-o"></i>
                                                    撤销核销
                                                </a>
                                            </div>
        ...
        <div class="am-modal am-modal-confirm" tabindex="-1" id="claimhexiao">
            <div class="am-modal-dialog">
                ...
                <div class="am-modal-footer">
                    ...
                    <span class="am-modal-btn" data-am-modal-confirm @click="waybill_hxgsure()">确定</span>
                </div>
            </div>
        </div>
        ...
        <div class="am-modal am-modal-confirm" tabindex="-1" id="claimchexiao">
            <div class="am-modal-dialog">
                ...
                <div class="am-modal-footer">
                    <span class="am-modal-btn" data-am-modal-cancel>取消</span>
                    <span class="am-modal-btn" data-am-modal-confirm @click="waybill_cxhxgsure()">确定</span>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(function(){
        var verify_id_ydhx;
        var verify_id_cxhkyd;
        var vm = new Vue({
            el: "#app_waybill", //引用div的id
            data: {
                submitUrl:"/getAllsyd.action", //跳转的路径
                verify:"",
                verifys: []//表单数据集合
            ...
            methods: {
                ...
                getAll : function(){
                    ...
                    //跳转的路径
                    currenr_this.submitUrl='/getAllsyd.action';
                    //通过json方式得到数据
                ...
                //核销
                waybill_yes:function (index) {
                    //拿到对象
                    var item=this.verifys[index];
                    //获取该对象的id
                    verify_id_ydhx=item.verify_id;
                    $('#claimhexiao').modal({});
                },
                //确定核销
                waybill_hxgsure:function () {
                    $.ajax({
                        url:'/update_verify_ydhxcontro.action',
                        data:{verify_id:verify_id_ydhx},
                        dataType:'JSON',
                ...
                waybill_no:function () {
                    ...
                    var item=this.verifys[index];
                    //获取该对象的id
                    verify_id_cxhkyd=item.verify_id;
                    $('#claimchexiao').modal({});
                },
                //确定撤销核销
                waybill_cxhxgsure:function () {
                    $.ajax({
                        url:'/update_verify_ydcxhxcontro.action',
                        data:{verify_id:verify_id_cxhkyd},
                        dataType:'JSON',
                        success:function(result){
                            alert('审核失误！');
                        },
...
<%--模态框--%>
   <%--批量查询--%>
  <div class="am-modal am-modal-no-btn" tabindex="" id="manysearch">
            ...
            <%--查询输入区域--%>
              <form action="" method="post">
                <table class="am-table am-table-centered am-text-middle am-text-nowrap" border="0">
                    ...
                    <tr>
                        <td>寄件网点&nbsp;:&nbsp;<input type="text" style="width:146px;"/></td>
                        <td>核销项目&nbsp;:&nbsp;
                            <select style="width:146px;">
                                <option value="option1">现付</option>
                                <option value="option2">IT业界</option>
                            </select>
                        </td>
                        <td></td>
                    ...
                    <tr>
                      <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          货号&nbsp;:&nbsp;<input type="text" style="width:146px;"/></td>
...
<%--核销--%>
<div class="am-modal am-modal-confirm" tabindex="-1" id="wayhexiao">
    <div class="am-modal-dialog">
        <div class="am-btn am-btn-warning am-btn-primary am-btn-block">运单费用项信息的确认</div>
        <div class="am-modal-bd">
            你，确定要核销这条记录吗？
        </div>
        <div class="am-modal-footer">
...
<%--撤销核销--%>
<div class="am-modal am-modal-confirm" tabindex="-1" id="waychexiao">
    <div class="am-modal-dialog">
        <div class="am-btn am-btn-warning am-btn-primary am-btn-block">运单费用项信息的撤销确认</div>
        <div class="am-modal-bd">
            你，确定要撤销核销这条记录吗？
        </div>
        <div class="am-modal-footer">
