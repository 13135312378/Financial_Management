...
<div class="am-g tpl-g">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-nav-link">
                ...
                <ul class="sidebar-nav sidebar-nav-sub" style="display: block;">
                    ...
                    <%--代收款批次发款--%>
                    <li class="sidebar-nav-link">
                        <a href="agency_batch.jsp" class="sub-active">
    ...
    <div class="tpl-content-wrapper" >
        ...
        <div class="container-fluid am-cf" style="height:26px;  ">
            <div class="page-header-heading" ><span class=""></span> 代收货款管理 <small>代收款批次发款 </small></div>
        </div>
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        ...
                        <div class="widget-head am-cf">
                            <div class="widget-title  am-cf">代收款批次发款</div>
                        </div>
                        ...
                        <div class="widget-body  am-fr">
                            ...
                            <div class="am-scrollable-horizontal">
                                <table width="100%" class="am-table am-table-bordered am-table-striped am-text-nowrap" id="example-r1" >
                                    ...
                                    <tbody id="fund_tb">
                                    <tr class="gradeX" v-for="(tbwaybill,index) in batch_tbwaybills" id="merges">
...
<script>
    ...
    $(function(){
        ...
        var vm = new Vue({
            el: "#app_batch", //引用div的id
            data: {
                submitUrl:"/get_All_operationfk.action", //跳转的路径
                tbwaybill:"",
                batch_tbwaybills: [],  //表单数据集合
                titleName:"",
                paymentId:""  //表单数据的id
            },
            methods: {
                ...
                getAll : function(){
                    ...
                    $.getJSON(currenr_this.submitUrl,function(result,status){
                        ...
                        currenr_this._data.batch_tbwaybills=result;
